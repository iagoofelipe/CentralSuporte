""" 
cadastramento no BioAC através do site de solicitações Serpro
...
class Bioac:
    ...
    def cadastrar(self, nome, cpf_agr, email):
        ...
        self.__webOpen()
        self.__driver.find_element(By.XPATH, '//*[@id="nav-home"]/div[2]/div/input').send_keys(Keys.HOME + r'19860129000106' + Keys.RETURN)
...
bioac = Bioac()
bioac.cadastrar('ALEX SANDRO LOPES DOS SANTOS', '00610710214', 'BB.SAN.ALEX@GMAIL.COM')